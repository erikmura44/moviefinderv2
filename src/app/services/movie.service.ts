...
export class MovieService {
  ...
  getInTheaters(){
    return this._jsonp.get('https://api.themoviedb.org/3/discover/movie?callback=JSONP_CALLBACK&primary_release_date.gte=2017-03-12&primary_release_date.lte=2017-03-28&api_key='+this.apikey)
      .map(res => res.json());
  }
